...
@Deprecated
public class ToolCall extends hcmute.edu.vn.tickticktodo.ai.llm.model.ToolCall {
    ...
    public static ToolCall fromEnvelope(AgentResponseEnvelope envelope) {
        hcmute.edu.vn.tickticktodo.ai.llm.model.ToolCall delegated =
                hcmute.edu.vn.tickticktodo.ai.llm.model.ToolCall.fromEnvelope(envelope);
        return new ToolCall(
                delegated.getCallId(),
