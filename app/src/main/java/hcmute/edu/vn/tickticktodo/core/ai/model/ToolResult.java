package hcmute.edu.vn.tickticktodo.core.ai.model;

import org.json.JSONObject;

@Deprecated
public class ToolResult extends hcmute.edu.vn.tickticktodo.ai.llm.model.ToolResult {
    ...
    public static ToolResult success(String callId, String toolName, JSONObject data) {
        hcmute.edu.vn.tickticktodo.ai.llm.model.ToolResult delegated =
                hcmute.edu.vn.tickticktodo.ai.llm.model.ToolResult.success(callId, toolName, data);
    ...
    public static ToolResult failure(String callId, String toolName, String errorCode, String errorMessage) {
        hcmute.edu.vn.tickticktodo.ai.llm.model.ToolResult delegated =
                hcmute.edu.vn.tickticktodo.ai.llm.model.ToolResult.failure(
                        callId,
                        toolName,
                        errorCode,
                        errorMessage
