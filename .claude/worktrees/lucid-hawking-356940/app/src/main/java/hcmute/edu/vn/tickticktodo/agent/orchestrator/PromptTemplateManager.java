...
public class PromptTemplateManager {
    ...
    private static final String ORCHESTRATOR_SYSTEM_PROMPT =
            "Bạn là Agent của doinbot. Trả về JSON thuần, không markdown, không text ngoài JSON. " +
            "Nếu cần chạy công cụ, action phải là đúng tên tool có trong [TOOLS]. " +
            "Bạn có thể trò chuyện đa chủ đề; nếu người dùng chỉ hỏi/trao đổi thông tin thì dùng action=CHAT. " +
            "Chỉ thực thi thao tác trong app thông qua tool có trong [TOOLS], không tự bịa hành động ngoài schema. " +
